            ...
            <div className='card rounded-2'>
              <div className='card-body p-4'>
                ...
                <p className='card-text'>
                  Mahuli Agro-tourism is dedicated to providing visitors with a
                  unique and memorable agro-tourism experience. We offer the
                  opportunity to immerse yourself in the beauty of rural life,
                  learn about sustainable agriculture practices, and connect
                  with nature. Located in Maharashtra, India, our farm offers a
                  variety of activities and comfortable accommodations for a
